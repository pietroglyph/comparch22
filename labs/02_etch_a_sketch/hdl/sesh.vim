...
set hidden
set ruler
set runtimepath=~/.vim,~/.vim/pack/plugins/start/vim-go,~/.vim/bundle/Vundle.vim,~/.vim/bundle/coc.nvim,~/.vim/bundle/vim-lsp-cxx-highlight,~/.vim/bundle/vim-lastplace,~/.vim/bundle/fzf.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.fzf,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/coc.nvim/after,~/.vim/bundle/vim-lsp-cxx-highlight/after,~/.vim/bundle/vim-lastplace/after,~/.vim/bundle/fzf.vim/after
...
silent only
silent tabonly
cd ~/work/src/github.com/pietroglyph/comparch22/labs/02_etch_a_sketch/hdl
...
badd +1 ../README.md
badd +0 main.sv
badd +0 ili9341_display_controller.sv
badd +0 ili9341_defines.sv
badd +0 spi_controller.sv
badd +0 spi_types.sv
badd +0 ft6206_controller.sv
badd +0 ft6206_defines.sv
badd +0 i2c_controller.sv
badd +0 i2c_types.sv
argglobal
%argdel
$argadd ../README.md
$argadd main.sv
$argadd ili9341_display_controller.sv
$argadd ili9341_defines.sv
$argadd spi_controller.sv
$argadd spi_types.sv
$argadd ft6206_controller.sv
$argadd ft6206_defines.sv
$argadd i2c_controller.sv
$argadd i2c_types.sv
set stal=2
...
setlocal indentkeys=!^F,o,O,0),0},=begin,=end,=join,=endcase,=join_any,=join_none,=endmodule,=endfunction,=endtask,=endspecify,=endclass,=endpackage,=endsequence,=endclocking,=endinterface,=endgroup,=endprogram,=endproperty,=endchecker,=`else,=`elsif,=`endif
setlocal noinfercase
...
normal! 0
tabnext
edit ili9341_display_controller.sv
argglobal
3argu
balt ../README.md
setlocal keymap=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 134 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 134
...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 41
